...
{
    public class IncidentWorker_SightstealerArrival_Patch
    {
        // Perceptors can warn of sightstealers arriving unexpectedly.
        [HarmonyPatch(typeof(IncidentWorker_SightstealerArrival), "TryExecuteWorker")]
        public class IncidentWorker_SightstealerArrival_TryExecuteWorker_Patch
        {
            [HarmonyPostfix]
