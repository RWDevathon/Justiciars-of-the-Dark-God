...
namespace ArtificialBeings
{
    ...
    public class Hediff_Ambition_Adamant : Hediff_Ambition
    {
        ...
        public override void NotifyFailed()
        {
            ...
            pawn.health.RemoveHediff(this);
            Find.LetterStack.ReceiveLetter("ABF_AmbitionFailed".Translate(), "ABF_AmbitionFailed_Adamant".Translate(pawn.LabelShort, pawn.Named("PAWN")).CapitalizeFirst(), LetterDefOf.NegativeEvent);
        ...
        public override void NotifySucceeded()
        {
            ...
            Find.LetterStack.ReceiveLetter("ABF_AmbitionSucceeded".Translate(), "ABF_AmbitionSucceeded_Adamant".Translate(pawn.LabelShort, pawn.Named("PAWN")).CapitalizeFirst(), LetterDefOf.PositiveEvent);
        }
    }
}
