...
namespace ArtificialBeings
{
    ...
    public class Hediff_Inspiration_Kinslayer : Hediff_MentalTracker
    {
        ...
        public override void NotifySucceeded()
        {
            ...
            pawn.health.RemoveHediff(this);
            Find.LetterStack.ReceiveLetter("ABF_InspirationSucceeded".Translate(), "ABF_InspirationSucceeded_Kinslayer".Translate(pawn.LabelShort, pawn.Named("PAWN")).CapitalizeFirst(), LetterDefOf.NeutralEvent);
        }
    }
}
