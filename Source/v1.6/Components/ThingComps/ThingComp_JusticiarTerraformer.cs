...
{
    // Effectively a direct copy of CompTerraformer, but which allows for operating on Long tick intervals.
    public class ThingComp_JusticiarTerraformer : ThingComp
    {
